...
| Spec 007 Formula / ERC / JCM | **本阶段实现已部署，用户确认大量参数与姿势工作正常，按授权中文归档** | [执行报告](007-erc-jcm/execution-report.md)；后续修复 Ren Yao / BGM 等兼容性；DAZ Studio Golden 待完成 |
...
现有材质参考与差异报告继续保留未完成项；005 已中文提交为 `ee2ba05`，006 为 `aa8fbc7`。007 本次按用户授权归档，部署位于 `out`；随后实施通用参数兼容性修复，无需新增第三方源码。进入 Genesis 8 服装绑定验证前，再收集同代服装 DUF 与内容库依赖。
